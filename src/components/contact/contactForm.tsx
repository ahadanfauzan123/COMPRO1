  ...
  return (
    <div className='flex-[0.5] mt-12 lg:mt-0'>
      ...
      onSubmit={async (e) => {
            ...
            setSubject('');
            setMessage('');
          }}  className="px-4 py-8 w-[90%] mx-auto lg:ml-auto flex flex-col space-y-3 shadow-2xl lg:shadow-lg bg-white rounded-2xl">
            {/* title */}
            ...
            <div className='w-full flex justify-between items-start'>
                  ...
                  <div className="flex-[0.48] flex flex-col space-y-1">
                        ...
                        <input 
                        className='w-full h-[48px] rounded-lg border-2 border-gray-300 text-sm px-3 ring-0 outline-0'
            ...
            <div className="flex-[0.48] flex flex-col space-y-1">
                        ...
                        <textarea 
                        className='w-full h-[100px] rounded-lg border-2 border-gray-300 text-sm px-3 ring-0 outline-0'
                        placeholder=''
                        value={message}
