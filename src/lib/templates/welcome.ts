...
<body>
    <div class="container">
        <div class="header">
            <img src="https://dummyimage.com/150x50/0b3552/ffffff&text=lexica" alt="lexica">
        </div>
        <div class="content">
            <h1>Pesan Baru dari Formulir Kontak Website Anda</h1>
            <img src="https://dummyimage.com/600x200/ccc/fff" alt="Contact Image">
            <p>Email pengirim: {{ email }}</p>
            <p>Email penerima: {{ to }}</p>
            <h2>Halo Tim Dukungan Lexica,</h2>
            <p>Anda telah menerima pesan baru melalui formulir kontak di website Anda. Berikut adalah rincian pesan yang telah dikirimkan:</p>
            <div class="details">
                <p>Nama: {{ name }}</p>
                <p>Telepon: {{ phone }}</p>
                <p>Email: {{ email }}</p>
